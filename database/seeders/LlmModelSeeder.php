...
class LlmModelSeeder extends Seeder
{
    public function run(): void
    {
        $models = [
            ...
            ['ollama_tag' => 'phi3.5:mini',      'display_name' => 'Phi-3.5 Mini',     'category' => 'qa',           'description' => 'Подобрена версия на Phi-3 Mini',                                           'strengths' => ['fast', 'qa', 'improved'],                             'ram_required_gb' => 2.5,  'size_mb' => 2200,  'is_default_for' => ['qa_verifier']],
