...
class LlmModelSeeder extends Seeder
{
    public function run(): void
    {
        $models = [
            ...
            ['ollama_tag' => 's_emanuilov/BgGPT-v1.0:9b', 'display_name' => 'BgGPT v1.0 9B',      'category' => 'bulgarian',    'description' => 'State-of-the-art Bulgarian модел от INSAIT, базиран на Gemma 2 9B',            'strengths' => ['bulgarian_text', 'natural_bg_language', 'powerful'],  'ram_required_gb' => 8.0,  'size_mb' => 6000,  'is_default_for' => []],
            ...
            ['ollama_tag' => 'gemma3:12b',       'display_name' => 'Gemma 3 12B',     'category' => 'general',      'description' => 'Ново поколение Google модел, 128K контекст, multimodal',                    'strengths' => ['128k_context', 'multimodal', 'high_quality'],         'ram_required_gb' => 10.0, 'size_mb' => 8100,  'is_default_for' => []],
            ...
            ['ollama_tag' => 'deepseek-r1:14b', 'display_name' => 'DeepSeek-R1 14B',  'category' => 'reasoning',    'description' => 'По-мощен reasoning от 8B, най-добрият под 15GB',                          'strengths' => ['reasoning', 'chain_of_thought', 'powerful'],          'ram_required_gb' => 11.0, 'size_mb' => 9000,  'is_default_for' => []],
            ['ollama_tag' => 'phi4-reasoning',  'display_name' => 'Phi-4 Reasoning',  'category' => 'reasoning',    'description' => 'Microsoft специализиран reasoning модел, съперничи на много по-големи',   'strengths' => ['reasoning', 'specialized', 'efficient'],             'ram_required_gb' => 11.0, 'size_mb' => 9100,  'is_default_for' => []],
            ...
            ['ollama_tag' => 'qwen2.5-coder:14b', 'display_name' => 'Qwen2.5 Coder 14B','category' => 'code',       'description' => 'Най-популярният code модел (16M pulls), отличен code reasoning',             'strengths' => ['code_generation', 'code_reasoning', 'popular'],       'ram_required_gb' => 11.0, 'size_mb' => 9000,  'is_default_for' => []],
            ...
            ['ollama_tag' => 'qwen2.5vl:7b',        'display_name' => 'Qwen2.5 VL 7B',        'category' => 'vision', 'description' => 'Alibaba vision модел, отличен за OCR и document understanding', 'strengths' => ['vision', 'ocr', 'document_understanding'], 'ram_required_gb' => 7.0, 'size_mb' => 5000, 'is_default_for' => []],
        ];
