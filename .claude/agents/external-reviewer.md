...
description: Use during plan-review or code-review for a cross-vendor SECOND OPINION from a different model/vendor (Codex, Cursor, Antigravity, or local Ollama). Catches bugs Claude misses. Read-only.
tools: Bash, Read
model: sonnet
---
...
- Force a specific vendor: `REVIEWER=codex bash scripts/ai-review.sh review` (vendors: `codex`, `cursor`, `antigravity`, `ollama`)
