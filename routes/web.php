...
use App\Http\Controllers\Client\Org\BillingController;
...
Route::domain(config('app.domain'))->group(function () {
    ...
    Route::middleware('is_admin')->prefix('admin')->name('admin.')->group(function () {
        ...
        // Бюджети — per-company автономен таван + дневна история на харчените кредити
        Route::get('budgets', [AdminBudgetController::class, 'index'])->name('budgets.index');
        Route::get('budgets/{company}', [AdminBudgetController::class, 'show'])->name('budgets.show');
        Route::get('budgets/{company}/history', [AdminBudgetController::class, 'history'])->name('budgets.history');
        Route::put('budgets/{company}', [AdminBudgetController::class, 'update'])->name('budgets.update');
    });
