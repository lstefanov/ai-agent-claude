    ...
    <section class="max-w-6xl mx-auto px-6 py-16">
        ...
        <div class="mt-8 grid md:grid-cols-2 gap-x-12 gap-y-8">
            ...
            $features = [
                ...
                ['puzzle-piece', 'Действа в реални системи', 'MCP конектори към Gmail, Sheets, Drive, Slack, Notion, Airtable или HTTP API — агентите четат и пишат, с одобрение преди запис.'],
            ];
            @endphp
