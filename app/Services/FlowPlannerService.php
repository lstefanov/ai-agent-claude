...
PROMPT;
        ...
        $user = "Компания: {$flow->company?->name} ({$flow->company?->industry})\n"
            ."Описание на flow:\n\"{$flow->description}\"";
...
7. system_prompt: минимум 3 изречения, на български — роля, стил, език, ограничения,
   какво НЕ трябва да прави (без измислици, фактите дословно).
8. prompt_template: минимум 5 изречения, на български — конкретни инструкции за формат,
   тон, дължина, какво да включи/изключи, с правилните placeholder-и.
